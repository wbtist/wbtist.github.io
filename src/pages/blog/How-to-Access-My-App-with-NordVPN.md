...
## Want to use the app but not in the US?

If you’ve tried to open my application and found it isn't working, it’s likely because you are currently outside the United States. To get things up and running, you strictly need a **VPN**.

### What if I don't know what a VPN is?

Don't worry if you aren't sure how it works or if you've never used one before. If you just want to give the app a quick go to see if you like it, you can easily find a free VPN to test things out.

However, for a smoother experience, I really recommend using a proper service.
